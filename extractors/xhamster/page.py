...
async def extract_videos_from_webpage(sem, session, url, initial_dict: bool = False, **kwargs):
    async with sem:
        async with session.get(url, **kwargs) as response:
            ...
            try:
                ...
                listPropsKey = [key for key in layoutPage.keys() if "videoListProps".lower() in key.lower()]
